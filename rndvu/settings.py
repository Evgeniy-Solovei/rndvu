"""
Django settings for rndvu project.
...
SECRET_KEY = 'django-insecure-v633p$7epvi)%%c@u6v=r%)27pk&v*i40y!%cws-j^#s=)-o8$'

# SECURITY WARNING: don't run with debug turned on in production!
CORS_ALLOW_METHODS = list(default_methods)  # в том числе PATCH, PUT, DELETE, OPTIONS
CORS_ALLOW_HEADERS = list(default_headers) + ["x-init-data", "x-test-mode"]
...
MIDDLEWARE = [
    ...
    'core_rndvu.middleware.telegram_auth.AsyncTelegramAuthMiddleware'
]

ROOT_URLCONF = 'rndvu.urls'
...
WSGI_APPLICATION = 'rndvu.wsgi.application'
...
DATABASES = {
    "default": {
        ...
        # Локально PostgreSQL может быть без SSL — делаем режим настраиваемым через окружение
        "OPTIONS": (
